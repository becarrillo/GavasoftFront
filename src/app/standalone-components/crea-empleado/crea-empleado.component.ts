...
export class CreaEmpleadoComponent implements OnInit {
  ...
  empleadoFormGroup : FormGroup<EmpleadoRegisterControls> = new FormBuilder().group<EmpleadoRegisterControls>({
    apellidosControl: new FormControl<string>('', [Validators.required, Validators.minLength(12), Validators.maxLength(33)]) as FormControl<string>,
    nombreControl: new FormControl<string>('', [Validators.required, Validators.minLength(3), Validators.maxLength(30)]) as FormControl<string>,
    ...
    passwordControl: new FormControl<string>(
      '',
      [Validators.required, Validators.minLength(8), Validators.maxLength(28), Validators.pattern(/\W+\w+/)]
  ...
  async submitEmpleado(ev : SubmitEvent) : Promise<void> {
    ...
    this.empleadoService.postEmpleado(this.empleado).subscribe((data : Empleado) => {
      this.empleado = {
        ...
        "fecha_entrada":  data.fecha_entrada as string,
    ...
    window.location.pathname = "menus/menu-administrador";
  }
